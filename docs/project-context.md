...
**Related:** [HIFL playbook](hifl-playbook.md) · [Intent](intent.md) · [Spec](spec.md) · Revise [internal/intent-revise-2026-09-17.md](../internal/intent-revise-2026-09-17.md) · Owner brief [internal/product-idea.md](../internal/product-idea.md)
...
### From owner HIFL Revise (2026-09-17)
...
Also locked for runtime: **Postgres**, **Redis** (catalog cache), **JWT** (local verify), **OpenAPI/Swagger**, **tests**, async PDF behavior, **Docker Compose** full-stack bring-up with volumes and sample data.
...
| 2026-09-17 | Intent + Spec remain **DRAFT** with gate asks after this Revise; **do not write design.md yet** | Locked (process) |
...
| [intent.md](intent.md) | Stage 1 Intent (revised — HIFL Revise 2026-09-17) |
| [spec.md](spec.md) | Stage 2 Spec / PRD (revised — HIFL Revise 2026-09-17) |
| [internal/intent-revise-2026-09-17.md](../internal/intent-revise-2026-09-17.md) | Owner HIFL Revise source for this update |
